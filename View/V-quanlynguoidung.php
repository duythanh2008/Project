            ...
            <div class="col l-2 m-0 c-0">
                <div class="admin-menu">
                    <ul class="admin-menu__list">
                        ...
                        <li id="menu1" class="admin-menu__item">
                            <a href="?controller=quanlynguoidung" class="admin-menu__item-link active">Quản lý người dùng</a>
                        </li>
                        <li class="admin-menu__item">
                ...
                <div class="admin-content">
                    <div class="row no-gutters">
                        <div class="col l-12 m-12 c-12">
                            <h3 class="admin-content__heading wow fadeInUp" data-wow-duration=".5s"  data-wow-delay=".1s">Quản lý người dùng</h3><br>
                            <form>
                                <input type="hidden" name="controller" value="quanlynguoidung">
                                <input
                                    style="     width: 400px;
                                                max-width: 100%;
                                                height:45px;
                                                ...
                                                outline: none;"
                                type="search" name="keyword" placeholder="Tìm người dùng ... " class="wow fadeInUp" data-wow-duration=".5s"  data-wow-delay=".2s"value="<?php echo (isset($_GET['keyword'])) ? $_GET['keyword'] : '' ?>">
                            </form>
                            <div class="admin__product">
                                <table class="admin__product-table wow fadeInUp" data-wow-duration=".5s"  data-wow-delay=".3s">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="admin__product-table-td">
                                                <input onclick="window.location ='?controller=xulinguoidung&method=edit&id=<?php echo $value['id']; ?>'" type="button" class="btn-option" value="Sửa">
                                                <input type="hidden" name="product-id" value="<?php echo $value['id'] ?>">
                                                <input onclick="window.location ='?controller=xulinguoidung&method=del&id=<?php echo $value['id']; ?>'" type="button" class="btn-option" value="Xóa">
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
