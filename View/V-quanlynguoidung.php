                ...
                <div class="admin-content">
                    <div class="row no-gutters">
                        <div class="col l-12 m-12 c-12">
                            <h3 class="admin-content__heading">Quản lý người dùng</h3><br>
                            <form>
                                ...
                                <input
                                    style="     width: 400px;
                                                ...
                                                outline: none;"
                                type="search" name="keyword" placeholder="Tìm người dùng ... "  value="<?php echo (isset($_GET['keyword'])) ? $_GET['keyword'] : '' ?>">
                            </form>
