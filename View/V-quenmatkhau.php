                                        ...
                                        <div class="row">
                                            <div class="col l-6 l-o-3 m-10 m-o-1 c-12">
                                                <div class="check__delivery-item wow fadeInUp" data-wow-duration=".5s"  data-wow-delay=".1s">
                                                    ...
                                                    <input type="text" name="email" id="email-input" <?php if (isset($_POST['email'])) { ?> value="<?php echo $_POST['email']; ?>"<?php } ?> placeholder="Nhập địa chỉ email"  class="check__delivery-input">
                                                    <?php if(isset($error)){?>
